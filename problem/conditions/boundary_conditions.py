class Boundary_Conditions:
    ...
    def Neumann_one_point(self, Uin, value):
        
        # dU/dx = ( U(x+1) - U(x-1) ) / (2*dx)
        
        Uout = Uin - 2*self.meshing_layer.dx*value
        
        return (Uout)

    def convection(self, T):
                
        return self.meshing_layer.h*(T-self.meshing_layer.Troom)/self.meshing_layer.kx
